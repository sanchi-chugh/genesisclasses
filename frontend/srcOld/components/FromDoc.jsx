...
class FromDoc extends React.Component {
  state = {
    courseList: [],
    course: '',
    description: '',
  ...
  handleSubmit = (event) => {
    ...
    this.setState({ busy: true, }, () => {
      ...
      axios.post('/api/tests/add/from-doc/', formdata, {
        headers: {
          Authorization: `Token ${localStorage.token}`,
        },
      })
      ...
      <div className={classes.root}>
        <Paper className={classes.container}>
          ...
          <ValidatorForm autoComplete="off" onSubmit={this.handleSubmit}>
            ...
            <br />
            <br />
            <input required type="file" name="doc" className={classes.textField} />
            <br />
            <br />
            <Button
              type="submit"
...
export default withStyles(styles)(FromDoc);